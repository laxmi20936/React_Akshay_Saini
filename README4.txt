...
------------------------------------------------------------------------
Importance of key:
When we pass key, react will optimise its render cycle. When we pass key, each component will be uniquely identified and react will not re-render the whole res-container.
